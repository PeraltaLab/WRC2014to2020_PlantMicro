...
#plot1
#Error: Aesthetics must be either length 1 or the same as the data (24): shape, colour and size
...
#pH
pH_aov <- aov(pH ~ fertilization*ditch*year, data = bc_diversity_M_Mf)
anova(pH_aov)
