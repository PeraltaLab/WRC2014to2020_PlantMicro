...
```
---------------------------------------------------------------------------------------------------------------------
*READ IN THE PLANT DIVERSITY (2018 ONLY) FILE AND EXP DESIGN* 
```{r}
file_path <- ("C:/Users/ohhey/OneDrive//Desktop/WRCcsvfiles/WRC18_plant_RA.csv") 
plant <- read.csv(file_path)

plant_design <- ("C:/Users/ohhey/OneDrive/Desktop/WRCcsvfiles/WRC18_design.csv")
...
```{r}
colors <- c("M" = "gray70", "MF" = "darkgreen","M" = "gray70", "MF" = "darkgreen","M" = "gray70", "MF" = "darkgreen") #SET COLORS FOR BOXPLOT


M_Mf <- bc_diversity[bc_diversity$treatment %in% c("M", "MF"), ]  #Filter out Mowed and Mowed/Fertilized only
...
theme_bw() + 
    ...
    theme(strip.text.x = element_text(size=14, face="bold"), strip.text.y =   
          ...
          fill="white", size=1))
#Save plot 
ggsave("C:/Users/ohhey/OneDrive/Pictures/rich.png", plot=rich, device=NULL, path=NULL, scale=1, width=6.3, height=4.4, dpi=900, limitsize=TRUE)
...
theme_bw() + 
    ...
    theme(strip.text.x = element_text(size=14, face="bold"), strip.text.y =   
          ...
          fill="white", size=1))
#Save plot 
ggsave("C:/Users/ohhey/OneDrive/Pictures/shannon.png", plot=shannon, device=NULL, path=NULL, scale=1, width=6.3, height=4.4, dpi=900, limitsize=TRUE)
...
theme_bw() + 
    ...
    theme(strip.text.x = element_text(size=14, face="bold"), strip.text.y =   
          ...
          fill="white", size=1))
#Save plot 
ggsave("C:/Users/ohhey/OneDrive/Pictures/simp.png", plot=simp, device=NULL, path=NULL, scale=1, width=6.3, height=4.4, dpi=900, limitsize=TRUE)
```
...
#Save plot 
ggsave("C:/Users/ohhey/OneDrive/Pictures/n_percent.png", plot=n_percent, device=NULL, path=NULL, scale=1, width=6.3, height=4.4, dpi=900, limitsize=TRUE)
```
...
ggtitle("16S rRNA Communnity Diversity")+
...
#Save plot 
ggsave("C:/Users/ohhey/OneDrive/Pictures/plot2.png", plot=plot2, device=NULL, path=NULL, scale=1, width=6.3, height=4.4, dpi=900, limitsize=TRUE)
```
*Statistics*
```{r}
#ALL TREATMENTS
...
adonis = adonis(design_bac1[,-c(1:6)] ~ fertilization*mowing*ditch*year, method = "bray", data = design_bac1, perm=1000, set.seed=42)
...
plot_rich <- ggplot(data=df_plantdesign) +
  geom_boxplot(aes(x=treatment, y=plant_richness, fill=treatment), na.rm = TRUE)+
  geom_point(aes(x=treatment, y=plant_richness, color=ditch), position=position_jitterdodge())+
  scale_color_manual(values = c("red", "blue", "gray"))+
  scale_fill_manual(values=c("purple", "green", "gold", "gray"))
plot_rich

#SAVE IMAGE 
ggsave("C:/Users/ohhey/OneDrive/Desktop/WRC2015.2018plots/plot_rich.png", plot=plot_rich, device=NULL, path=NULL, scale=1, width=6.3, height=4.4, dpi=900, limitsize=TRUE)
...
plot_shannon <- ggplot(data=df_plantdesign) +
  geom_boxplot(aes(x=treatment, y=plant_shannon, fill=treatment), na.rm = TRUE)+
  geom_point(aes(x=treatment, y=plant_shannon, color=ditch), position=position_jitterdodge())+
  scale_color_manual(values = c("red", "blue", "gray", "green"))+
  scale_fill_manual(values=c("purple", "green", "gold", "blue"))

plot_shannon

ggsave("C:/Users/ohhey/OneDrive/Desktop/WRC2015.2018plots/plot_shannon.png", plot=plot_shannon, device=NULL, path=NULL, scale=1, width=6.3, height=4.4, dpi=900, limitsize=TRUE)
...
plot_invsimp <- ggplot(data=df_plantdesign) +
  geom_boxplot(aes(x=treatment, y=plant_invsimp, fill=treatment), na.rm = TRUE)+
  geom_point(aes(x=treatment, y=plant_invsimp, color=ditch), position=position_jitterdodge())+
  scale_color_manual(values = c("red", "blue", "gray"))+
  scale_fill_manual(values=c("purple", "green", "gold", "blue"))
...
#save image
ggsave("C:/Users/ohhey/OneDrive/Desktop/WRC2015.2018plots/plot_invsimp.png", plot=plot_invsimp, device=NULL, path=NULL, scale=1, width=6.3, height=4.4, dpi=900, limitsize=TRUE)
